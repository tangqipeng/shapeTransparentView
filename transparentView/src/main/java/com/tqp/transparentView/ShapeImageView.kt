    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        when (mShapeView) {
            CIRCLE -> {
                ...
                val rectF = RectF(paddingLeft.toFloat(), paddingTop.toFloat(), (paddingLeft + 2*mRadius), (paddingTop + 2*mRadius))
